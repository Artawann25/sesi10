...
<head>
    ...
    <title>latihan form 2 id</title>
</head>
<body>
    
    <form name="latihan1" id="latihan1" method="POST" onsubmit="return checkform(this)">
        <div>
            NIM
        ...
        <div>
            ...
            <input type="checkbox" name="txhobivoly" id="txhobivoly"value="3">Voly
            <input type="checkbox" name="txhobibasket" id="txhobibasket"value="4">basket
            <input type="checkbox" name="txhobitenis" id="txhobitenis"value="5">tenis
        </div>
